...
export const placeholderCategories: Category[] = [
  { id: "cat1", name: "Fiber Cables", slug: "fiber-cables", imageUrl: "https://placehold.co/300x300.png?text=Fiber+Cables" },
  { id: "cat2", name: "Connectors", slug: "connectors", imageUrl: "https://placehold.co/300x300.png?text=Connectors" },
  { id: "cat3", name: "Adapters", slug: "adapters", imageUrl: "https://placehold.co/300x300.png?text=Adapters" },
  { id: "cat4", name: "Patch Panels", slug: "patch-panels", imageUrl: "https://placehold.co/300x300.png?text=Patch+Panels" },
  { id: "cat5", name: "Networking Tools", slug: "networking-tools", imageUrl: "https://placehold.co/300x300.png?text=Networking+Tools" },
  { id: "cat6", name: "SFP Modules", slug: "sfp-modules", imageUrl: "https://placehold.co/300x300.png?text=SFP+Modules" },
  { id: "cat7", name: "Media Converters", slug: "media-converters", imageUrl: "https://placehold.co/300x300.png?text=Media+Converters" },
  { id: "cat8", name: "Cable Management", slug: "cable-management", imageUrl: "https://placehold.co/300x300.png?text=Cable+Management" },
  { id: "cat9", name: "Testers", slug: "testers", imageUrl: "https://placehold.co/300x300.png?text=Testers" },
  { id: "cat10", name: "Enclosures", slug: "enclosures", imageUrl: "https://placehold.co/300x300.png?text=Enclosures" },
];
