...
export const placeholderCategories: Category[] = [
  { id: "cat1", name: "Fiber Cables", slug: "fiber-cables", imageUrl: "https://placehold.co/300x300.png?cat=fiber-cables" },
  { id: "cat2", name: "Connectors", slug: "connectors", imageUrl: "https://placehold.co/300x300.png?cat=connectors" },
  { id: "cat3", name: "Adapters", slug: "adapters", imageUrl: "https://placehold.co/300x300.png?cat=adapters" },
  { id: "cat4", name: "Patch Panels", slug: "patch-panels", imageUrl: "https://placehold.co/300x300.png?cat=patch-panels" },
  { id: "cat5", name: "Networking Tools", slug: "networking-tools", imageUrl: "https://placehold.co/300x300.png?cat=networking-tools" },
  { id: "cat6", name: "SFP Modules", slug: "sfp-modules", imageUrl: "https://placehold.co/300x300.png?cat=sfp-modules" },
  { id: "cat7", name: "Media Converters", slug: "media-converters", imageUrl: "https://placehold.co/300x300.png?cat=media-converters" },
  { id: "cat8", name: "Cable Management", slug: "cable-management", imageUrl: "https://placehold.co/300x300.png?cat=cable-management" },
  { id: "cat9", name: "Testers", slug: "testers", imageUrl: "https://placehold.co/300x300.png?cat=testers" },
  { id: "cat10", name: "Enclosures", slug: "enclosures", imageUrl: "https://placehold.co/300x300.png?cat=enclosures" },
];
...
export const placeholderSuppliers: Supplier[] = [
  {
    ...
    logoUrl: "https://placehold.co/150x150.png?sup=opticonnect",
    bannerUrl: "https://placehold.co/1200x300.png?sup=opticonnect-banner",
  ...
  },
  {
    ...
    logoUrl: "https://placehold.co/150x150.png?sup=netbuild",
    bannerUrl: "https://placehold.co/1200x300.png?sup=netbuild-banner",
